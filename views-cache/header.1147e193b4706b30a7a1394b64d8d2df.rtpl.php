...
<head>
    ...
    <script src="/res/js/personalizado.js"></script>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <!--                            <li class="nav-item">-->
                    <!--                                <a href="/res/index.html" class="nav-link">-->
                    <!--                                    <i class="far fa-circle nav-icon"></i>-->
                    <!--                                    <p>Dashboard v1</p>-->
                    <!--                                </a>-->
                    <!--                            </li>-->
                    <!--                            <li class="nav-item">-->
                    <!--                                <a href="/res/index2.html" class="nav-link">-->
                    <!--                                    <i class="far fa-circle nav-icon"></i>-->
                    <!--                                    <p>Dashboard v2</p>-->
                    <!--                                </a>-->
                    <!--                            </li>-->
                    <!--                            <li class="nav-item">-->
                    <!--                                <a href="/res/index3.html" class="nav-link">-->
                    <!--                                    <i class="far fa-circle nav-icon"></i>-->
                    <!--                                    <p>Dashboard v3</p>-->
                    <!--                                </a>-->
                    <!--                            </li>-->
                    ...
                    <li class="nav-item">
                        <a href="/administrador/usuario" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="/administrador/regiao" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="/administrador/valvula" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="/administrador/grupo" class="nav-link">
